...
const RelatorioEmprestimosClienteCompleto = () => {
    ...
    const handleSearch = async (e) => {
        ...
        try {
            const response = await api.get(`/emprestimos/findByCliente/${filters.clienteId}`);
    ...
    return (
        <div>
            <div className="form-panel">
                <h3>Listagem de Empréstimos (Por Cliente)</h3>
            ...
            {searched && (
                <div className="table-container">
                    <h3>Empréstimos de {getClienteNome()}</h3>
                    <table className="table">
                        ...
                        <tbody>
                            ...
                            {emprestimos.length === 0 && (
                                <tr>
                                    <td colSpan="3" className="text-center">Nenhum empréstimo encontrado</td>
                                </tr>
                            )}
                        </tbody>
                        {emprestimos.length > 0 && (
...
export default RelatorioEmprestimosClienteCompleto;
