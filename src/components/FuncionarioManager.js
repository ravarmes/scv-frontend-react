...
const FuncionarioManager = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            setError(err.response?.data?.message || err.response?.data?.err || 'Erro ao salvar funcionário');
            console.error(err);
        }
    };
                    ...
                    <tbody>
                        {funcionarios.map(funcionario => (
                            <tr key={funcionario.id}>
                                ...
                                <td>{funcionario.rua}, {funcionario.numero}</td>
                                <td>{getBairroNome(funcionario.bairroId)}</td>
